...
export module Services {
  ...
  await firstValueFrom(this.create(defBrand, namedQuery, namedQueryConfig));
    ...
    async performNamedQuery(brandIdFieldPath, resultObjectMapping, collectionName, mongoQuery, queryParams, paramMap, brand, start, rows, user = undefined, sort: NamedQuerySortConfig | undefined = undefined): Promise<ListAPIResponse<NamedQueryResponseRecord>> {
    ...
    public async performNamedQueryFromConfig(config: NamedQueryConfig, paramMap, brand, start, rows, user?): Promise<ListAPIResponse<NamedQueryResponseRecord>> {
...
declare global {
  var NamedQueryService: Services.NamedQueryService;
}

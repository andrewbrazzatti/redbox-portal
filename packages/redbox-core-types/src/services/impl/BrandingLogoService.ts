...
// MongoDB types are available at runtime from root project's node_modules
...
export module Services {
  ...
  export class BrandingLogo extends coreServices.Core.Service {
    ...
    private cachedBucket: any | null = null;
    ...
    private getBucket(): any {
      ...
      try {
        ...
        const db: any = ds?.manager; // sails-mongo exposes native Db as manager
        if (!db) return null;
...
declare global {
  var BrandingLogoService: Services.BrandingLogo;
}

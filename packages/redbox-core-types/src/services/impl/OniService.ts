...
// oni-ocfl types are available at runtime from root project's node_modules
// Use require() to avoid TypeScript compilation errors when dependency isn't present
...
export module Services {
	...
	export class OniService extends services.Core.Service {
		 ...
		 * @param tempDir
		 */
		private async writeDatasetObject(creator: Object, approver: Object, oid: string, drid: string, targetCollector: any, rootCollection: any, record: Object, tempDir:string): Promise<any> {
		 ...
		 * @param rootCollection
		 */
		private async writeDatasetROCrate(creator: Object, approver: Object, oid:string, attachments: any[], record: Object, targetCollector: any, rootCollection: any) {
			const metadata = record['metadata'];
			const metaMetadata = record['metaMetadata'];
...
declare global {
  var OniService: Services.OniService;
}

 ...
 */
import type { Req, Res } from '../../sails';
import { Controllers as controllers } from '../../index';
import type { Services as BrandingServices } from '../../services/impl/BrandingService';
import type { Services as BrandingLogoServices } from '../../services/impl/BrandingLogoService';
...
export module Controllers {
  export class Branding extends controllers.Core.Controller {
    ...
    async rollback(req: Req, res: Res) {

 ...
 */
import { BrandingModel, Controllers as controllers, ReportAttributes } from '../../index';
export module Controllers {
  ...
  export class Report extends controllers.Core.Controller {
    ...
    public async get(req, res) {
      ...
      const report: ReportAttributes = await ReportsService.get(brand, req.param('name'));

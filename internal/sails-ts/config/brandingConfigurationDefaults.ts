...
import { BrandingConfigurationDefaultsConfig } from '@researchdatabox/redbox-core-types';
...
const authConfig = {
  ...
  hiddenRoles: [] as string[],
  hiddenUsers: [] as string[],
  postLogoutRedir: '/default/rdmp/home'
};

const brandingConfigurationDefaultsConfig: BrandingConfigurationDefaultsConfig = {
